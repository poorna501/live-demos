	...
	<div class = "col-xs-12">
		<div class = "ct-box-main">
			...
			<div class = "col-xs-12">
				...
				<ul><li id="text1" class="opacity00">The <span class = "ct-code-b-green">fwrite()</span> function is 
					used for <span class = "ct-code-b-green">writing</span> an structure block to a given file 
					Syntax: <span class = "ct-code-b-green"> fwrite (&Structure_variable, sizeof(structure), 
					integer, file_pointer);</span><br></li>
					<li id="text2" class="opacity00">The <span class = "ct-code-b-green">fread()</span> function is 
						used for <span class = "ct-code-b-green">reading</span> an entire structure block from a given file. The 
							syntax is same as fwrite() function. syntax <span class = "ct-code-b-green">
	  					...
	  					<div class="col-xs-8 col-xs-offset-2 padding00 margin-top">
							<div class="output-console center" id="outputDiv">
		        					...
		        					<div class="output-console-body" id="outputConsoleBody">
		        						...
		        						<span class='output-scanf-line' id='outputScanfLine'><span class = "input-box" maxlength="2" id = "employeeId"></span>&nbsp;&nbsp;<span class = "input-box" spellcheck="false" maxlength="10" id = "employeeName"></span>&nbsp;&nbsp;<span class = "input-box" maxlength="10" id = "employeeSalary"></span></span><br>
