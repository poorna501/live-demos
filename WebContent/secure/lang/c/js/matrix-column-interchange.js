...
function introFunction() {
			...
			switch (elementId) {
				...
				case "matrixRowInterChange" :
					...
					text = 'This is the sample <span class="ct-code-b-yellow">program</span> to '
							+ 'interchange the <span class="ct-code-b-yellow">column</span> values.';
				...
				case "arrDec" :
					...
					text = 'Here, we are declaring and initializing an integer array'
							+ ' <span class="ct-code-b-yellow">arr[3][3]</span> and the variables are '
							+ '<span class="ct-code-b-yellow">row</span>,'
							+ '<span class="ct-code-b-yellow"> col</span>, '
							+ '<span class="ct-code-b-yellow">col1</span>, '
							+ '<span class="ct-code-b-yellow">col2</span>, and '
							+ '<span class="ct-code-b-yellow">temp</span> value is initialized to '
					...
					switch(animateStep) {
						...
						case "printBeforeVal" :
							...
							text = 'This <span class="ct-code-b-yellow">for</span> loop is used to print'
									+ ' the matrix values on to the console.';
							typing('.introjs-tooltiptext', text, function() {
				...
				case "outputDiv":
					...
					switch(animateStep) {
						case "readMatrixValues" :
							$('.introjs-tooltip').removeClass('hide');
							var text = "press <b class='ct-code-b-yellow'>enter</b> key for next entry.";
							typing(".introjs-tooltiptext", text, function() {
								tableIndex();
						...
						case "readRowValuas" :
							$('.introjs-tooltip').removeClass('hide');
							var text ="Enter <b class='ct-code-b-yellow'>col1</b> and <b class='ct-code-b-yellow'>"
					 				+ "col2</b> values separated by a <b class='ct-code-b-yellow'>space</b>.</br></br>"
					 				+ "For example your want to exchanged <b class='ct-code-b-yellow'>first column</b>"
					 				+ " and <b class='ct-code-b-yellow'>second column</b> values"
						...
						case "printAfterExchange" :
							valIndex++;
							$("#consoleBodyDiv1").append("<div id='value"+ valIndex +"'>"
										+ "The matix after interchanging the two columns(in the original matrix</div>");
				...
				case "scanf" + count :
					$('.introjs-tooltip').removeClass('hide');
					text = 'The <span class="ct-code-b-yellow">scanf()</span> function is used to read'
							+ ' the two integer values as '
							+ '<span class="ct-code-b-yellow">col1</span> and <span class="ct-code-b-yellow">col2</span>.';
					typing('.introjs-tooltiptext', text, function() {
						count++;
	...
	$('.introjs-tooltip').removeClass('hide');
	text = 'In this <span class="ct-code-b-yellow">live demo</span> we will learn '
			+ 'how the <span class="ct-code-b-yellow">column</span> values will be '
			+' <span class="ct-code-b-yellow">interchage</span> '
			+ ' from one colum to another.'
	typing('.introjs-tooltiptext', text, function() {
		$('.introjs-nextbutton').show();
	});
}
...
function falseCondition(selector) {
	...
	$('.introjs-tooltip').removeClass('hide');
	text = 'The condition <b class="ct-code-b-yellow">col1 &gt;= 0</b> && <b class="ct-code-b-yellow">col2 &gt;= 0</b>'
			+' && <b class="ct-code-b-yellow">col1 &lt; 3</b> && <b class="ct-code-b-yellow">col2 &lt; 3</b>'
...
function changeRowValues() {
	...
	flipEffectWithTweenMax("#rowCon", col , function() {
		if (col < 3) {
			$("#forRowCon").addClass("true");
			$("#trueOrFalse").text("=====> true").addClass("green-color");
			arrow("#forLoop", "#tempValSpan", function() {
				flipEffectWithTweenMax("#arrRowIdx1", col1 , function() {
					flipEffectWithTweenMax("#arrRow1", col , function() {
						$('.introjs-tooltip').removeClass('hide');
						text = 'The <b class="ct-code-b-yellow">arr['+ col +']['+ col1 +']</b> value i.e (<b class="ct-code-b-yellow">'
								+ $(".sortEle" +col+""+col1).text() +'</b>) is stored in the variable'
								+ ' <b class="ct-code-b-yellow">temp</span>.';
						typing('.introjs-tooltiptext', text, function() {
							$('.introjs-tooltipbuttons').append("<a class='introjs-button introjs-duplicate-nextbutton'>Next &#8594;</a>");
							$(".introjs-duplicate-nextbutton").click(function() {
								$(".introjs-duplicate-nextbutton").remove();
								swapArrValToArr(col1, col2);
							});
						});
					});
				});
			...
			$('.introjs-tooltip').removeClass('hide');
			text = 'The column <b class="ct-code-b-yellow">'+ col1 +'</b> and  <b class="ct-code-b-yellow">'
					+ col2 +'</b> elements are exchanged successfully.'
			typing('.introjs-tooltiptext', text, function() {
				$('.introjs-tooltipbuttons').append("<a class='introjs-button introjs-duplicate-nextbutton'>Next &#8594;</a>");
				$(".introjs-duplicate-nextbutton").click(function() {
					$('.introjs-tooltip').addClass('hide');
...
function swapArrValToArr(col1, col2) {
	$('.introjs-tooltip').addClass('hide');
	fadeInFromEffectWithTimelineMax(".sortEle" +col+""+col1 , "#tempVal", function() {
		arrow("#tempValSpan", "#row1MinVal", function() {
			flipEffectWithTweenMax("#arrRowIdx2", col2 , function() {
				flipEffectWithTweenMax("#arrRow2", col , function() {
					flipEffectWithTweenMax("#arrRowIdx3", col1 , function() {
						flipEffectWithTweenMax("#arrRow11", col , function() {
							$('.introjs-tooltip').removeClass('hide');
							text = 'The <b class="ct-code-b-yellow">arr['+ col +']['+ col2 +']</b> value i.e (<b class="ct-code-b-yellow">'
									+ $(".sortEle" +col+""+col2).text() +'</b>) is stored in '
									+ ' <b class="ct-code-b-yellow">arr['+ col +']['+ col1 +']</b>.'
							typing('.introjs-tooltiptext', text, function() {
								$('.introjs-tooltipbuttons').append("<a class='introjs-button introjs-duplicate-nextbutton'>Next &#8594;</a>");
								$(".introjs-duplicate-nextbutton").click(function() {
									$('.introjs-tooltip').addClass('hide');
									$(".introjs-duplicate-nextbutton").remove();
									swapTempToArr(col1, col2);
								});
							});	
						});
					});
...
function swapTempToArr(col1, col2) {
	$('.introjs-tooltip').addClass('hide');
	fadeInFromEffectWithTimelineMax(".sortEle" +col+""+col2 , ".sortEle" +col+""+col1, function() {
		arrow("#row1MinVal", "#row2MinVal", function() {
			flipEffectWithTweenMax("#arrRowIdx4", col2 , function() {
				flipEffectWithTweenMax("#tRow2", col , function() {
					$('.introjs-tooltip').removeClass('hide');
					text = 'The temp value i.e (<b class="ct-code-b-yellow">'
							+ $("#tempVal").text() +'</b>) is stored in '
							+ '<b class="ct-code-b-yellow"> arr['+ col +']['+ col2 +']</b>.';
					typing('.introjs-tooltiptext', text, function() {
						$('.introjs-tooltipbuttons').append("<a class='introjs-button introjs-duplicate-nextbutton'>Next &#8594;</a>");
						$(".introjs-duplicate-nextbutton").click(function() {
							$('.introjs-tooltip').addClass('hide');
							$(".introjs-duplicate-nextbutton").remove();
							storeTempValue(col1, col2);
						});
					});	
				});
			});
...
function storeTempValue(col1, col2) {
	fadeInFromEffectWithTimelineMax("#tempVal" , ".sortEle" +col+""+col2, function() {
...
arr = [];
$("#secondInput").removeAttr('disabled').focus();;
...
$('#secondInput').on("keyup", function(e) {
	...
	if ($(this).val() == "") {
		...
		$('.introjs-tooltiptext').append("<span class='ct-code-b-red length-error-text'><br/>" + 
											"Please enter col1 and col2 values each separated by a space.</span>");
	} 
	...
	if (arr.length == 1 && e.keyCode == 8 && $('.backspace-error').length == 0 ) {
		$('.introjs-tooltiptext').append("<span class='ct-code-b-red backspace-error "
				+ "length-error-text'></br>Enter two numbers separated by space.</span>");
	}
			...
			if ($.inArray(aFirst, size) !== -1 && $.inArray(aSecond, size) !== -1) {
				...
				if ($('.size-error').length == 0 ) {
					...
					$('.introjs-tooltiptext').append("<span class='ct-code-b-red size-error length-error-text'>"
							+ "</br>size should be 0 to 3(inclusive)</span>");
				}
			}
		  } else {
		  	$(".introjs-nextbutton").hide();
		  	$('.introjs-tooltiptext').append("<span class='ct-code-b-red length-error-text'> "
					+"<br/> Please follow the above format.</br>col1 and col2 values must be in numbers.</span>");
		  }
	} else {
		$(".introjs-nextbutton").hide();
	}
