...
<script src="/secure/lang/cpp/js-min/bscpp.min.js"></script>
...
<span id="preproceserDir"></span>
	...
	<span id="variableDec">int len = 8, <span class="outer-loop-color">outer</span>Idx, <span class="inner-loop-color">inner</span>Idx, elementAt<span class="inner-loop-color">Inner</span>Idx = 0, print;</span>
	<span id="bubbleSortLogic">for (<span class="outer-loop-color">outer</span>Idx = 0; <span class="outer-loop-color">outer</span>Idx < len - 1; <span class="outer-loop-color">outer</span>Idx++) {
		for (<span class="inner-loop-color">inner</span>Idx = 0; <span class="inner-loop-color">inner</span>Idx < len - <span class="outer-loop-color">outer</span>Idx - 1; <span class="inner-loop-color">inner</span>Idx++) {
			if(arr[<span class="inner-loop-color">inner</span>Idx] > arr[<span class="inner-loop-color">inner</span>Idx + 1]) {
				elementAt<span class="inner-loop-color">Inner</span>Idx = arr[<span class="inner-loop-color">inner</span>Idx];
				arr[<span class="inner-loop-color">inner</span>Idx] = arr[<span class="inner-loop-color">inner</span>Idx +1];
				arr[<span class="inner-loop-color">inner</span>Idx + 1] = elementAt<span class="inner-loop-color">Inner</span>Idx; 
			}
		}
	}</span>
			...
			<div class="col-xs-12 box-border padding00" id="animationDiv">
				<div class="col-xs-12 padding00">
					<div class="col-xs-12 text-center opacity00" id="eleAtInnerIdx">
						<div class="col-xs-12 text-center"><div id="eleAtInnerText">elementAt<span class="inner-loop-color">Inner</span>Idx</div></div>
...
<span id="bubbleSortLogic">	<span id="outerForLoop">for(<span id="outerInti"><span class="outer-loop-color">outer</span>Idx = 0</span>; <span id="outerLoop"><span class="outer-loop-color">outer</span>Idx < len - 1</span>; <span id="outerInc"><span class="outer-loop-color">outer</span>Idx++</span>) {</span>
		<span id="innerForLoop">for(<span id="innerInti"><span class="inner-loop-color">inner</span>Idx = 0</span>; <span id="innerLoop"><span class="inner-loop-color">inner</span>Idx < len - <span class="outer-loop-color">outer</span>Idx - 1</span>; <span id="innerInc"><span class="inner-loop-color">inner</span>Idx++</span>) {</span>
			<span id="ifConditionCheck">if(<span id="ifCondition"><span id="ifInnerIdx">arr[<span class="inner-loop-color">inner</span>Idx]</span> > <span id="ifInnerIdxPlsOne">arr[<span class="inner-loop-color">inner</span>Idx + 1]</span></span>) {</span>
				<span id="swapValues"><span id="storeValueInOuterIdx"><span id="storeArrInnerIdxVal">elementAt<span class="inner-loop-color">Inner</span>Idx</span> = <span id="arrInnerIdxVal">arr[<span class="inner-loop-color">inner</span>Idx]</span>;</span>
				...
				<span id="storeEleOuterIdxVal">arr[<span class="inner-loop-color">inner</span>Idx + 1] = <span id="arrOuterIdxVal">elementAt<span class="inner-loop-color">Inner</span>Idx</span>;</span></span> 
