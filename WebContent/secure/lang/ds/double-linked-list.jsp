...
<script src="/secure/lang/ds/js/double-linked-list.js"></script>
<!-- <script src="/secure/lang/ds/js/dll.js"></script> -->
	...
	<div class="col-xs-12 padding00">
		<div class="ct-box-main">
			 <div class="text-center">
				<h1 class="label ct-demo-heading text-center" id="headingSection">Doubly Linked List</h1>
			</div> 
		</div>
