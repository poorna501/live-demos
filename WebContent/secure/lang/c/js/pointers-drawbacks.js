...
function introJsFunction() {
	...
	introjs.onafterchange(function(targetElement) {
		...
		switch (elementId) {
		case "preCode":
			var typingContent = 'Let us know the drawbacks of <span class="ct-code-b-yellow">Pointers</span> in ' +
			...
			$('.introjs-helperLayer').one('transitionend', function () {
				...
				case "xBoxAnimate":
					var typingContent = 'The variable <span class="ct-code-b-yellow">x</span> is of type ' +
										...
										'of memory with address <span class="ct-code-b-yellow">1111</span>.</br>' +
										'Then the value <span class="ct-code-b-yellow">3</span> is ' +
										'initialized.';
					typing('.introjs-tooltiptext', typingContent, typingInterval, 'white', function() {
			...
			$('.introjs-helperLayer').one('transitionend', function () {
				...
				case "pBoxAnimate":
					var typingContent = 'Here, the <span class="ct-code-b-yellow">pointer</span> variable <span class="ct-code-b-yellow">p</span> is of ' +
										...
										'of memory with address <span class="ct-code-b-yellow">1234</span>.</br>' +
										'The initial value of the <span class="ct-code-b-yellow">pointer</span> variable is '
										' <span class="ct-code-b-yellow">garbage</span> value.' +
										/*'<span class="ct-code-b-yellow">pointer</span> variable initial ' +
			...
			$('.introjs-helperLayer').one('transitionend', function () {
				...
				case "*pValueAnimate":
					var typingContent = 'The <span class="ct-code-b-yellow">pointer</span> variable <span class="ct-code-b-yellow">p</span> is pointed ' +
										...
										'changed to <span class="ct-code-b-yellow">20</span>.<br/>'+
										'The <span class="ct-code-b-yellow">drawback</span> is without knowing to the variable <span class="ct-code-b-yellow">x</span>, '+
										'the value of variable <span class="ct-code-b-yellow">x</span> has been changed through '+
		...
		case "print1":
			$('.introjs-helperLayer').one('transitionend', function () {
				var typingContent = 'The <span class="ct-code-b-yellow">printf()</span> function is used to prints the'
									+' <span class="ct-code-b-yellow">value</span> of <span class="ct-code-b-yellow">x</span>.';
				typing('.introjs-tooltiptext', typingContent, typingInterval, 'white', function() {
					$('.introjs-nextbutton').show();
				});
			});
		...
		case "print2":
			$('.introjs-helperLayer').one('transitionend', function () {
				var typingContent = 'The <span class="ct-code-b-yellow">printf()</span> function is used to prints the'
									+' <span class="ct-code-b-yellow">value</span> of <span class="ct-code-b-yellow">*p</span>.';
				typing('.introjs-tooltiptext', typingContent, typingInterval, 'white', function() {
					$('.introjs-nextbutton').show();
				});
			});
