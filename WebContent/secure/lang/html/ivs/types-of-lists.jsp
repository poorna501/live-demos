	...
	introjs.onafterchange(function(targetElement) {
		...
		case "ulbrowser":
			if (introjs._currentStep == 7) {
				...
				$(".introjs-helperLayer").one("transitionend", function() {
					...
					typing(".introjs-tooltiptext", text, function() {
						$("#outputDiv1").append("<ul id='ulFirstLi'><span><li id='liTransfer1'></li></span></ul>");
						$('.introjs-nextbutton').show();
					});
				});
		...
		case "olbrowser":
			if (introjs._currentStep == 40) {
				...
				$(".introjs-helperLayer").one("transitionend", function() {
					...
					typing(".introjs-tooltiptext", text, function() {
						$("#outputDiv2").append("<ol id='olAppendLi'><span><li id='liTransfer11'></li></span></ol>");
						$('.introjs-nextbutton').show();
					});
				});
		...
		case "dtData1":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				charAtEnd("dtData1");
				introjs.refresh();
				var text = "Enter <b class ='ct-code-b-yellow'>CodeTabtra</b> inside <b class ='ct-code-b-yellow'>&lt;dt&gt;</b> tag.</b>"
				typing(".introjs-tooltiptext", text, function() {
					textFocus("dtData1");
					++buttonCount;
				});
		...
		case "ddData1":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				charAtEnd("ddData1");
				introjs.refresh();
				var text = "Enter <b class ='ct-code-b-yellow'>WWW</b> inside <b class ='ct-code-b-yellow'>&lt;dd&gt;</b> tag.</b>"
				typing(".introjs-tooltiptext", text, function() {
					textFocus("ddData1");
					++buttonCount;
				});
		...
		case "dtData2":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				charAtEnd("dtData2");
				introjs.refresh();
				var text = "Enter <b class ='ct-code-b-yellow'>World Wide Web</b> inside <b class ='ct-code-b-yellow'>&lt;dt&gt;</b> tag.</b>"
				typing(".introjs-tooltiptext", text, function() {
					textFocus("dtData2");
					++buttonCount;
				});
		...
		case "ddData2":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				charAtEnd("ddData2");
				introjs.refresh();
				var text = "Enter the data inside <b class ='ct-code-b-yellow'>&lt;dd&gt;</b> tag.</b>"
				typing(".introjs-tooltiptext", text, function() {
					textFocus("ddData2");
					++buttonCount;
				});
...
<div class="col-xs-12">
	<div class="col-xs-offset-2 col-xs-3 margin-top-20">
...
<span id="olHtmlCloseTag" class="opacity00">&lt;/html&gt;</span></pre>  
	...
	<div class="col-xs-5 margin-top-20">
		<div id="olbrowser" class="opacity00">
			<img class="browser-img" alt="" src="ct-img.png">
			<div id="outputDiv2" class="output-div">
			</div>
		</div>
	</div>
</div>
<div class="col-xs-12">
	<div class="col-xs-offset-2 col-xs-3 margin-top-20">
		...
		<pre class="creampretab1"><span id="dlHtmlOpenTag" class="opacity00">&lt;html&gt;</span>
  <span id="dlBodyOpenTag" class="opacity00">&lt;body&gt;</span>
    <span id="dlOpenTag" contenteditable='true', spellcheck='false', maxlength='4' originalText='&lt;dl&gt;'></span>
      <span id="firstDt"><span id="enterDtOpenTag1" contenteditable='true', spellcheck='false', maxlength='4' originalText='&lt;dt&gt;'></span><span id="dtData1" contenteditable='true', spellcheck='false', maxlength='2'></span><span id="enterDtCloseTag1" contenteditable='true', spellcheck='false', maxlength='5' originalText='&lt;/dt&gt;'></span></span>
      <span id="firstDd"><span id="enterDdOpenTag1" contenteditable='true', spellcheck='false', maxlength='4' originalText='&lt;dt&gt;'></span><span id="ddData1" contenteditable='true', spellcheck='false', maxlength='10'></span><span id="enterDdCloseTag1" contenteditable='true', spellcheck='false', maxlength='5' originalText='&lt;/dt&gt;'></span></span>
      <span id="secondDt"><span id="enterDtOpenTag2" contenteditable='true', spellcheck='false', maxlength='4' originalText='&lt;dt&gt;'></span><span id="dtData2" contenteditable='true', spellcheck='false', maxlength='3'></span><span id="enterDtCloseTag2" contenteditable='true', spellcheck='false', maxlength='5' originalText='&lt;/dt&gt;'></span></span>
      <span id="secondDd"><span id="enterDdOpenTag2" contenteditable='true', spellcheck='false', maxlength='4' originalText='&lt;dt&gt;'></span><span id="ddData2" contenteditable='true', spellcheck='false', maxlength='14'></span><span id="enterDdCloseTag2" contenteditable='true', spellcheck='false', maxlength='5' originalText='&lt;/dt&gt;'></span></span>
...
<span id="dlHtmlCloseTag" class="opacity00">&lt;/html&gt;</span></pre>
	...
	<div class="col-xs-5 margin-top-20">
		<div id="dlbrowser" class="opacity00">
			<img class="browser-img" alt="" src="ct-img.png">
			<div id="outputDiv3" class="output-div">
			</div>
		</div>
	</div>
</div>
