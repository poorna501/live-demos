...
function introGuide() {
	...
	introjs.onafterchange(function(targetElement) {
		...
		case "browser":
			if (introjs._currentStep == 10) {
				...
				$(".introjs-helperLayer").one("transitionend", function() {
					...
					typing($(".introjs-tooltiptext"), text, function() {
						$("#outputDiv1").append("<div id='browserHeader'><h1 class='text-center'> CodeTantra </h1></div>");
				...
				$(".introjs-helperLayer").one("transitionend", function() {
					...
					typing($(".introjs-tooltiptext"), text, function() {
						$("#outputDiv1").append("<div id='browserDiv1'><h1 class='text-center'> CodeTantra </h1><ul id='browserNav' style='list-style-type:none;'>"
				...
				$(".introjs-helperLayer").one("transitionend", function() {
					...
					typing($(".introjs-tooltiptext"), text, function() {
						$("#outputDiv1").append("<div id='browserDiv2'><h1 class='text-center'> CodeTantra </h1>"
								+"<div class='col-xs-12'>"
								+"<div class='col-xs-3'>"
								...
								+ "<h3> About Courses </h3><h3> Java </h3><p>This section covers all the fundamentals of Java" 
								+ " programming language.</p>"
								+ "<h3>Selenium</h3><p>This section teaches how to write Automated" 
								+ " Test Code using Selenium WebDriver in Java.</p>"
								+"</div>"
								+"</div>");
				...
				$(".introjs-helperLayer").one("transitionend", function() {
					...
					typing($(".introjs-tooltiptext"), text, function() {
						$("#outputDiv1").append("<div id='browserDiv3'><h1 class='text-center'> CodeTantra </h1>"
								+"<div class='col-xs-12'>"
								+"<div class='col-xs-3'>"
								+"<ul id='browserNav' style='list-style-type:none; margin-left: -50px; margin-top: 16px;'>"
								+ "<a href='#'><li>About Us</li></a><a href='#'><li>Contact Us</li></a><a href='#'><li>Courses</li></a></ul><p></div>"
								...
								+ "<h3> Price </h3><p>&nbsp;Java 4999</p><p>&nbsp;Selenium 3999</p>"
								+"</div>"
								+"</div>");
				...
				$(".introjs-helperLayer").one("transitionend", function() {
					...
					typing($(".introjs-tooltiptext"), text, function() {
						$("#outputDiv1").append("<div id='browserDiv4'><h1 class='text-center'> CodeTantra </h1>"
								+"<div class='col-xs-12'>"
		...
		case "totalATags":
			introjs.refresh();
			$("#totalATags").removeClass("opacity00");
			introjs.refresh();
			$('.introjs-nextbutton').hide();
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
		...
		case "asideData":
			introjs.refresh();
			$("#asideData").removeClass("opacity00");
			introjs.refresh();
			$('.introjs-nextbutton').hide();
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
...
<span id="totalHeader"><input id="headerOpenTag" class="hide input-css0" maxlength='8' originalText="<header>">
	<span id="totalHeaderH1" class="opacity00">&lt;h1 style='text-align: center;'&gt; CodeTantra &lt;h1&gt;</span>
...
<span id="totalNav"><input id="navOpenTag" class="hide input-css2" maxlength='5' originalText="<nav>">
	<span id="totalATags" class="opacity00">&lt;a href="about.jsp"&gt; About Us&lt;a&gt;
...
<span id="totalSection"><input id="sectionOpenTag" class="hide input-css8" maxlength='9' originalText="<section>">
	<span id="sectionH1" class="opacity00">&lt;h1&gt; About Courses &lt;/h1&gt;</span>
	<span id="totalArticle"><input id="articleOpenTag1" class="hide input-css0" maxlength='9' originalText="<article>">
		<span id="articleH1" class="opacity00">&lt;h1&gt; Java &lt;/h1&gt;</span>
		<span id="articleP1" class="opacity00">&lt;p&gt; This section covers all the fundamentals of Java 
	...
	<input id="articleOpenTag2" class="hide input-css0" maxlength='9' originalText="<article>">
		<span id="articleH2" class="opacity00">&lt;h1&gt; Selenium &lt;/h1&gt;</span>
		<span id="articleP2" class="opacity00">&lt;p&gt;This section teaches how to write Automated 
		Test Code using Selenium WebDriver in Java.&lt;/p&gt;</span>
...
<span id="totalAside"><input id="asideOpenTag" class="hide input-css0" maxlength='7' originalText="<aside>">
	<span id="asideData" class="opacity00"><span id="asideH">&lt;h1&gt; Price &lt;/h1&gt;</span>
	<span id="asideP1">&lt;p&gt; Java 4999 INR &lt;/p&gt;</span>
	<span id="asideP2">&lt;p&gt; Selenium 3999 INR &lt;/p&gt;</span></span>
...
<span id="totalFooter"><input id="footerOpenTag" class="hide input-css0" maxlength='8' originalText="<footer>">
	<span id="totalFooterP" class="opacity00">&lt;p&gt; @CodeTantra.com &lt;p&gt;</span>
