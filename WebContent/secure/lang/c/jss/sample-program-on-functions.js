...
function introGuide() {
	...
	introjs.onafterchange(function(targetElement) {
		...
		case "demoTitle":
			...
			var text = "Let us see, what is <b class ='ct-code-b-yellow'> Function Declaration</b>"
		...
		case "leftDiv":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				...
				var text = "Let us consider a sample <b class ='ct-code-b-yellow'>C</b> program.";
				typing($(".introjs-tooltiptext"), text, function() {
					$(".introjs-nextbutton").show();
				});
			});
		...
		case "funDec":
				$('.introjs-nextbutton').hide();
				$(".introjs-helperLayer").one("transitionend", function() {
					var text = "Here is a function declaration with the name <b class ='ct-code-b-yellow'> addition</b>."
							+ " It has two integer arguments with the return type integer.";
					typing($(".introjs-tooltiptext"), text, function() {
						$(".introjs-nextbutton").show();
					});
				});
		...
		/* case "main":
			...
			introjs.refresh();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "<ul><li><b class ='ct-code-b-yellow'>main():</b> is called by the operating system.</li>"
					+ "<li>main() is the  the execution starting point.</li></ul>";
				typing($(".introjs-tooltiptext"), text, function() {
					introjs.refresh();
					$(".introjs-nextbutton").show();
				});
		...
		case "varDec":
			...
			introjs.refresh();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Here, you can change the values of <b class ='ct-code-b-yellow'>a</b> and <b class ='ct-code-b-yellow'>b</b>.";
				typing($(".introjs-tooltiptext"), text, function() {
					charAtEnd("aVal");
					introjs.refresh();
					$(".introjs-nextbutton").show();
		...
		case "callingFun":
			if (introjs._currentStep == 5){
				...
				introjs.refresh();
				$(".introjs-helperLayer").one("transitionend", function() {
					var text = "Here, after calling addition(), control Immediately goes to the called function i.e "
				...
				introjs.refresh();
				$(".introjs-helperLayer").one("transitionend", function() {
					var text = "The return value will be stored into sum.";
					typing($(".introjs-tooltiptext"), text, function() {
						$(".introjs-nextbutton").show();
					});
				});
		...
		case "return":
			...
			introjs.refresh();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Return type of the function integer so it returns integer value.<br>"
				typing($(".introjs-tooltiptext"), text, function() {
