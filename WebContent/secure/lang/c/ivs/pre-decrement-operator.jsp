...
<script src="/secure/lang/c/jss/pre-decrement-operator.js"></script>
<!-- <script src="/secure/lang/c/js-min/pdo.min.js"></script> -->
...
<div class = "col-xs-12">
	<div class = "ct-box-main">
		 <div class = "text-center">
			<h1 class = "label ct-demo-heading text-center">Pre decrement operator</h1>
		</div> 
				...
				<div class = 'col-xs-12 padding0'>
					<div class = 'col-xs-8 col-xs-offset-2 padding0' id = "animationDiv1">
						<div class = 'col-xs-12 text-center animation-div1 padding0'>
							<span id = 'yVariableLine' class = "box-padding ">int y = <span class = "box-padding" id = "predecrement"><span id="ct-code-b-blue">--</span>x</span></span>
							<svg class = 'svg-css'>
								<marker id = "arrowEnd" refX = "4" refY = "2.5" markerWidth = "5" markerHeight = "5" orient = "auto" style = "fill: gray;">
									<path d = "M0,0 L5,2.5 L0,5 Z"/>
								</marker>
								<text fill = "#333">
									<tspan x = "41%" y = "17%" fill = "white" class = 'svg-text'>pre-decrement</tspan>
								</text>
