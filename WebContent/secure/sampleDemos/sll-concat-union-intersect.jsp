...
var tempLine = 11, qLine = 111, infoLine =33, typingSpeed = 10;
var flag = lineClass = false, concatflag;
...
function createDynamicNodes(selector, nodeNum) {
	...
	$(selector).append('<div class="opacity00 col-xs-2 nodes node" id="node' + nodeNum 
							...
							+ ' <span id="next' + nodeNum +'" class="position next-span ct-green-color ct-fonts inline-style">'
							+ '</span></div></div>'
							+ ' <div class="col-xs-12 padding00"><div class="col-xs-6 padding00 text-center">'
							+ ' <span id="dataAddress' + nodeNum + '" class="data-address padding00 ct-brown-color ct-fonts">'
							+ randomAddress +'</span></div></div></div>');
}
...
function noOfNodesInUnion() {
	$("#NoOfListsInUnion").append('<div class="col-xs-12 text-center ct-blue-color ct-fonts padding00 opacity00"'
							+ ' id = "inUnion">In Union</div>')
	for (var i = 0; i < arr.length; i++ ) {
	...
	introjs.onafterchange(function (targetElement) {
			...
			switch (elementId) {
				...
				case "buttonDiv" :
					...
					$("#inMainMet, #inUnion, #l1NodeInUn, #l1ValInUn").addClass("opacity00");
				...
				case "typeDefDec" :
					$('.introjs-tooltip').removeClass('hide');
					var text = "The <span class='ct-code-b-yellow'>typedef</span> creates a "
								+ "'<span class='ct-code-b-yellow'>nodeptr</span> as a"
				...
				case "nodeDec" :
					...
					var text = 'Here, we are declaring <span class="ct-code-b-yellow">three</span> '
								+ 'variables <span class="ct-code-b-yellow"> '
								+ 'l1</span>, <span class="ct-code-b-yellow">l2</span>, and '
				...
				case "nodeToNull" :
					$('.introjs-tooltip').removeClass('hide');
					var text = 'Here, we are initializing <span class="ct-code-b-yellow">l1</span>, '
								+ '<span class="ct-code-b-yellow">l2</span>,'
								+ ' and <span class="ct-code-b-yellow">l3</span> to '
				...
				case "animatinDiv" :
					...
					switch(animateStep) {
						...
						case "decForNodes" :
							$('.introjs-tooltip').removeClass('hide');
							var text = 'Here, we are declaring <span class="ct-code-b-yellow">l3</span>,'
									+ ' <span class="ct-code-b-yellow">t1</span>,'
									+ ' <span class="ct-code-b-yellow">t2</span> and, '
									+ '<span class="ct-code-b-yellow">q</span>, nodes. The'
									+ ' <span class="ct-code-b-yellow">q</span> node will be initialized '
...
function firstValueStoredInLNodes() {
