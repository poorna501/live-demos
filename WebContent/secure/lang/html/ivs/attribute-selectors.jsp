		...
		case "secondSelect":
			...
			$('.introjs-helperLayer ').one('transitionend', function() {
				var text = "We can select the attribute from the first select option and different signs "
							...
							+"<li><span><b>|</b></span> an element whose attribute has a hyphen-separated list of values beginning (from the left) </li>"
							+"<li><span><b>^</b></span> an element whose attribute value begins exactly with the string. </li>"
							+"<li><span><b>$</b></span> an element whose attribute value ends exactly with the string.</li><li>"
							+"<span><b>*</b></span> an element whose attribute value contains the substring.</li>"
							+"<li><span><b>~</b></span> an element whose attribute value is a list of whitespace-separated values, One of which is exactly equal.</li></ul>.";
				typing(".introjs-tooltiptext", text, function() {
					$('.introjs-nextbutton').show();
				});
			});
...
function firstSelectorAnimation() {
	...
	transfer(classCount,count,"background","#2d66d8");
}
