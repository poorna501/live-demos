...
<div id='styleDiv'>
<span id='totalStyle'><input id="selector" class="input-css" maxlength='18'> {
...
&lt;/html&gt;</pre>
	...
	function selectorChecking(pseudoSelector) {
		...
		$('#styleDiv input').on("keyup", function(e) {
			$('#styleDiv input').val($('input').val().trim());
			if ($('#styleDiv input').val() == pseudoSelector) {
	...
	function finalAnimation(classValue) {
		...
		console.log($('#browserText '+$('input').val()));
