...
function introGuide() {
	...
	if (lang == "cpp") {
		...
		$('#ifPrintfStmt').text('cout << "The key element " << searchElement << " is found at the position : " << mid;');
		$('#elsePrintfStmt').text('cout << "The Key element " << searchElement << " is not found in the array\n";');
	} else {
		$('#preproceserDir').text("#include <stdio.h>\nint main() {");			
		$('#ifPrintfStmt').text('printf("The search element %d is found at the position : %d.", searchElement, mid);');
