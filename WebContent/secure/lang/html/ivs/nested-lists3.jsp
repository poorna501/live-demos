	...
	introjs.onafterchange(function(targetElement) {
		...
		case "browser":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				...
				typing($(".introjs-tooltiptext"), text, function() {
					$("#outputDiv").append("<span><ul id='firstUl1'><li id='firstLi1'>Online Training</li></ul></span>");
				...
				$(".introjs-helperLayer").one("transitionend", function() {
					var text = "The result of <b class ='ct-code-b-yellow'>Unorder List</b>.";
					typing($(".introjs-tooltiptext"), text, function() {
						$("#outputDiv").append("<span><ol id='appendToOl'><li>Java</li></ol></span>");
						$('.introjs-nextbutton').show();
					});
				});
...
<div class="col-xs-12 text-center margin-top-20">
    ...
    <!-- <span id="olOpen"><input id="inputOlOpen" class="input-css1" maxlength='4'></span> -->			