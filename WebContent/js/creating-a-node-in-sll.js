			...
			switch (elementId) {
				...
				case "typeDef" :
					...
					text = 'The <span class="ct-code-b-yellow">typedef</span> creates a '
							+ '<span class="ct-code-b-yellow">node</span> as ';
							+ ' new type <span class="ct-code-b-yellow">pointer</span> '
							+ 'to datatype <span class="ct-code-b-yellow">struct list</span>. '
					typing('.introjs-tooltiptext', text, function() {
				...
				case "creFirst" :
					...
					text = 'Here we are declaring a variable <span class="ct-code-b-yellow">first</span> '
							...
							+ '<span class="ct-code-b-yellow">pointer</span> '
				...
				case "callCreateFun" + printCount :
					...
					switch(animateStep) {
						case "callCreateFun1" :
							...
							if (printCount == 1) {
								text = 'Here we call the '
									+ '<span class="ct-code-b-yellow">createNode()</span> function and '
						...
						case "returnTempVal":
							$('.introjs-tooltip').removeClass("hide");
							if (printCount == 1 ) {
								text = 'The <span class="ct-code-b-yellow">createNode()</span> function '
									  + '<span class="ct-code-b-yellow">return</span> value is stored in'
									  + ' the variable <span class="ct-code-b-yellow">first</span>.';
							} else {
								text = 'The <span class="ct-code-b-yellow">createNode()</span> function '
									  + '<span class="ct-code-b-yellow">return</span> value is stored in'
									  + ' the variable <span class="ct-code-b-yellow">first -> next</span>.';
							}
							typing('.introjs-tooltiptext' , text, function() {
								if (printCount == 1) {
				...
				case "firstData" + printCount:
					...
					if (printCount == 1) {
						...
						+ '</span> is stored in the <span class="ct-code-b-yellow">first -> data</span>.';
					} else {
						text = 'The <span class="ct-code-b-yellow">x</span> value <span class="ct-code-b-yellow">'+ val 
						+ '</span> is stored in the <span class="ct-code-b-yellow">first -> next -> data</span>.';
					}
					typing('.introjs-tooltiptext' , text, function() {
				...
				case "creTemp":
					$('.introjs-tooltip').removeClass("hide");
					text = 'Here we are declaring a '
							+ '<span class="ct-code-b-yellow">pointer</span> '
							+ 'variable <span class="ct-code-b-yellow">temp</span>.';
					typing('.introjs-tooltiptext' , text, function() {
				...
				case "credataInfoNode" :
					$('.introjs-tooltip').removeClass("hide");
					text = 'Here we are create a <span class="ct-code-b-yellow">node</span> '
							+ 'with <span class="ct-code-b-yellow">data</span> and'
							+ ' <span class="ct-code-b-yellow">next</span> field and '
							+ 'allocate <span class="ct-code-b-yellow">dynamic menory</span>.';
					typing('.introjs-tooltiptext' , text, function() {
				...
				case "tempNext" :
					$('.introjs-tooltip').removeClass("hide");
					text = 'Here we are assign <span class="ct-code-b-yellow">temp -> next</span> '
							+ 'to  <span class="ct-code-b-yellow">NULL</span>.';
					typing('.introjs-tooltiptext' , text, function() {
