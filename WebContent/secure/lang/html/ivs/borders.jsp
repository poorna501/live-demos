...
<span id="styleCloseTag">&lt;/style&gt;</span></div>
	<span id="bodyOpenTag">&lt;body&gt; </span>
		<div id="ptag" class="position"><input id="pTagOpen" type="text" size="3" maxlength='3'>
		<input id="pTagText" type="text" size="33" maxlength='33'>
		<input id="pTagClose" type="text" size="4" maxlength='4'></div>
				...
				<div class="col-xs-6">
					<div class = "col-xs-12 padding00" id = "htmlDisplay">
						...
						<!-- <div class ="col-xs-12 html-body" id = "htmlBody">
							<span id = "pcontent" class="opacity00">Apply different types of borders</span>
						</div> -->
					</div>
				</div>
			</div>
