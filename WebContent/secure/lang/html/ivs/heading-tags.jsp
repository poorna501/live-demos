			...
			case "divTagText" + inputFieldCount :
				...
				if (inputFieldCount < 6) {
					$("#divTag").append('<div id="spanCount'+ (inputFieldCount + 1) +'"><input id="divTagText'+ (inputFieldCount + 1) +
							'" type="text" size="18" maxlength="18"></div>');					
				} 
...
<div class="col-xs-12">
		<div class="ct-box-main">
			<div class="text-center">
				<h1 class="label ct-demo-heading text-center" id="fontIntroduction">Heading (&lt;h1&gt; to &lt;h6&gt;) Tag</h1>
			</div>
					...
					<div class='tab-container'>
						<ul class="tabs clearfix" >
							<li class="active" id="titleOfThePage">
								<div class="col-xs-10">h1 to h6 Tag</div>
