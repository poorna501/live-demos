...
function introGuide() {
	...
	introjs.onafterchange(function(targetElement) {
		...
		case "action":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter action="<b class ="ct-code-b-yellow">data.jsp</b>".<br> The action attribute specifies where to send the form-data when a form is submitted.';
				typing($(".introjs-tooltiptext"), text, function() {
					charAtEnd("url");
				});
			});
		...
		case "listValue":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter list="<b class ="ct-code-b-yellow">courses</b>".<br>The list attribute refers to a &lt;datalist&gt; element that contains pre-defined options for an &lt;input&gt; element.';
				typing($(".introjs-tooltiptext"), text, function() {
					charAtEnd("listText");
				});
			});
		...
		case "totalDataList":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "Let us create a <b class ='ct-code-b-yellow'>datalist</b>.";
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "idValue":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter id="<b class ="ct-code-b-yellow">courses</b>". To tie a datalist to an input element, give the input element a list attribute and the datalist an id attribute that match.';
				typing($(".introjs-tooltiptext"), text, function() {
					charAtEnd("idText");
				});
			});
		...
		case "option1Value":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter value="<b class ="ct-code-b-yellow">C</b>".<br> The &lt;option&gt; tag can be used without any attributes, but you usually need the value attribute, which indicates what is sent to the server.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "option2Value":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter value="<b class ="ct-code-b-yellow">Java</b>".<br> The &lt;option&gt; tag can be used without any attributes, but you usually need the value attribute, which indicates what is sent to the server.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "option3Value":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter value="<b class ="ct-code-b-yellow">Selenium</b>".<br> The &lt;option&gt; tag can be used without any attributes, but you usually need the value attribute, which indicates what is sent to the server.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "option4Value":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter value="<b class ="ct-code-b-yellow">HTML</b>".<br> The &lt;option&gt; tag can be used without any attributes, but you usually need the value attribute, which indicates what is sent to the server.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "option5Value":
			...
			$('.introjs-prevbutton').hide();
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = 'Enter value="<b class ="ct-code-b-yellow">CSS</b>".<br> The &lt;option&gt; tag can be used without any attributes, but you usually need the value attribute, which indicates what is sent to the server.';
				typing($(".introjs-tooltiptext"), text, function() {
		...
		case "onInput":
			...
			$(".introjs-helperLayer").one("transitionend", function() {
				var text = "<ul><li>Enter <b class ='ct-code-b-yellow'>rating.value=parseInt(input.value)</b></li><li>oninput execute a JavaScript when a user writes something in an input field.</li>"
...
function codetantra() {
	...
	$("#outputDiv2").append("<div><h5>Your Rating: " + $("output").val() + "</h5></div>");
	$("#outputDiv2").append("<div><h5>Your Comments: " + $("#outputTextArea").val() + "</h5></div>");
		...
		<div id="code" class="opacity00 padding0">
			<span id="htmlOpenTag" class="opacity00">&lt;html&gt;</span><br>
				...
				&emsp;&emsp;<div id="totalForm"><span id="formOpenTag" class="opacity00">&lt;form <span id="onInput" class="hide">oninput="<input id="onInputText" class="hide input-css6" maxlength='34' originalText="rating.value=parseInt(input.value)">"</span> <span id="action" class="hide">action="<input id="url" class="hide input-css1" maxlength='8' originalText="data.jsp">"</span>&gt;</span><br>
						...
						<div id="totalTextArea"><span id="comments" class="opacity00">&emsp;&emsp;&emsp;&emsp;&lt;label&gt;Please write your comments below.&lt;/label&gt;</span><br>
						...
						&emsp;&emsp;&emsp;&emsp;<span id="textAreaCloseTag" class="opacity00">&lt;/textarea&gt;</span></div>
						&emsp;&emsp;&emsp;&emsp;<span id="submit" class="opacity00">&lt;input type="button" value="submit"&gt;</span><br>
						&emsp;&emsp;<span id="formCloseTag" class="opacity00">&lt;/form&gt;</span></div>
